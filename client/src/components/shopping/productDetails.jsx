      ...
      <DialogContent className="grid md:grid-cols-2  gap-8 sm:p-12 max-w-[90vw] sm:max-w-[80vw] lg:max-w-[70vw]">
        ...
        <div className="">
          ...
          <div className="flex items-center justify-between">
            <p className={`text-3xl font-bold text-primary ${productDetails?.salePrice > 0 ? 'line-through':''}` }>XAF{productDetails?.price}</p>
            {
            productDetails?.salePrice > 0 ? <p className="text-2xl font-bold text-muted-foreground">XAF{productDetails.salePrice}</p>:''}
