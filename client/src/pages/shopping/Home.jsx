  ...
  return (
    <div className="flex flex-col min-h-screen">
     <Carousel
        ...
        interval={2000}
        infiniteLoop={true}
        showArrows={true} // Enable arrows to move manually between slides
        showThumbs={false}
        showStatus={false}
        showIndicators={true} // You might want indicators for a better user experience
        stopOnHover={true}
      >
        {Slides.map((item, index) => (
          <div key={index} className="background relative w-full h-[600px] overflow-hidden hover:opacity-90 ">
            <img
              src={item.image}
              alt={`Slide ${index + 1}`}
